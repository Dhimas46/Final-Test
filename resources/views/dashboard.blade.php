      ...
      <div class="card-body">
        <table class="table table bordered">
          ...
          <tbody>
            ...
            <div class="modal fade" id="editModal{{$row->id}}" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="" action="{{url('satuan-update/'.$row->id)}}" method="post">
                      @csrf
                      <label>Asal</label>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu text-left" role="menu">
                    ...
                    <a data-toggle="modal" data-target="#editModal{{$row->id}}" class="dropdown-item" href="">&nbsp<i class="fa fa-info"></i>&nbsp &nbsp Detail</a>
                      </form>
                      <form class="d-inline" action="{{url('update-aktif/'.$row->id)}}" method="post">
                      @csrf
                      @if($row->status == '0')
